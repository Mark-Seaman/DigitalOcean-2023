...
def document_card(document):
    markdown_text = open(f'Documents/markseaman.info/Test/{document}.md').read()
...
def lorem(num_words):
    text = open('Documents/markseaman.info/Test/lorem.txt').read()
...
def tabs_data():
    ...
    def create_pane_3():
        ...
        data['tables'] = [table_data('Documents/markseaman.info/Test/lessons.csv')]
        return data
...
def super_data():
    return dict(document=document_data('markseaman.info/Test/README'),
