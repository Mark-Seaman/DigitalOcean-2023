...
class RemoteBlogPagesTest(DjangoTest):
    def test_blog_seamanslog(self):
        self.assertPageLines("https://seamanslog.com", 100, 255)

    def test_blog_spirit(self):
        self.assertPageLines("https://spiritual-things.org", 100, 255)

    def test_blog_mark_seaman(self):
        self.assertPageLines("https://markseaman.org", 120, 255)
